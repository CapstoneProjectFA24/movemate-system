...
//                var updateResult = await _walletService.UpdateWalletBalance(wallet.WalletId, (float)wallet.Balance);
...
//                var order =await _unitOfWork.OrderRepository.GetByIdAsync(response.OrderId);
//                if(order == null)
//                {
//                    throw new NotFoundException("Order not found");
//                }
              
//                var walletUserWin = await _unitOfWork.WalletRepository.GetByIdAsync((int)order.UserId);
//                walletUserWin.Balance -= payment.Amount;

//                await _unitOfWork.WalletRepository.UpdateAsync(walletUserWin);

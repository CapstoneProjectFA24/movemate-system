...
namespace MoveMate.Service.ViewModels.ModelRequests
{
    ...
    {
        public MomoOneTimePaymentRequest(string partnerCode, string requestId, string amount, string orderId, string orderInfo, string redirectUrl, string ipnUrl, string requestType, string extraData, string lang)
        {
        ...
        public (bool,string?) GetLink(string paymentUrl)
        {
            ...
            var createPaymentLinkes = client.PostAsync(paymentUrl, requestContent).Result;
            if(createPaymentLinkes.IsSuccessStatusCode)
            {
                var responseContent = createPaymentLinkes.Content.ReadAsStringAsync().Result;
            ...
            {
                return (false, createPaymentLinkes.ReasonPhrase);
            }
        }
    }
}
